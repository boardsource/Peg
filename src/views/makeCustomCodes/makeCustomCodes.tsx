...
import Scroller from '../../components/sideScroller/sideScroller'
...
export default function MakeCustomCodes() {
  ...
  return (
    <MainView title="Custom Keycodes" description={`Custom keycode can be like macros and just send a whole word with a single keypress. 
      ...
      <div className="flex bg-red-200 h-full w-full relative">
        <div className="MakeCustomCodes flex flex-col bg-yellow-200">
          <Input
            label="Display text:"
        ...
        <div className="flex flex-col bg-green-200">
          custom codes
          <Scroller list={Array.from(keycodes.customCodes.values())} size='300' stickySide='right' />
